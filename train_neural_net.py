...
def play_game():
	...
	# q_table1 = q_learning_2_2_data[0]
	...
	if len(q_learning_scores)>100:
		...
		plt.plot(short_q_learning_scores)
		plt.plot(short_random_player_scores,'--')
		plt.ylabel('scores plot')
		plt.show()
	else:
		plt.plot(q_learning_scores)
		plt.plot(random_player_scores,'--')
		plt.ylabel('scores plot')
		plt.show()
