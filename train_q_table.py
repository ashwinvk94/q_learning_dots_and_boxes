...
def play_game():
	...
	for k in range(n_games):
		...
		while not check_board_full(board):
			...
			if check_board_full(board):
				...
				q_table = update_q_table(q_table,prev_action_index,prev_state,curr_state,reward,learning_rate,discount_factor,all_board_indices1)
	...
	q_learning_2_2_data = [q_table]
	with open('q_learning_2_2_data.pkl', 'wb') as f:
		pickle.dump(q_learning_2_2_data, f)
